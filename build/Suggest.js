...
var suggest = function (query, options) {
    if (options) {
        return YamapSuggests.suggestWithOptions(query, options);
    }
    return YamapSuggests.suggest(query);
};
var suggestWithCoords = function (query, options) { return __awaiter(void 0, void 0, void 0, function () {
    var suggests;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, suggest(query, options)];
            case 1:
                suggests = _a.sent();
